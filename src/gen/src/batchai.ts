...
export class az_batchai_cluster_file implements ICommandParent<any> {
    commandPath = "az batchai cluster file";
     ...
     */
    az_batchai_cluster_file_list(cluster: string, resourceGroup: string, workspace: string): az_batchai_cluster_file_list_command_builder {
        return new az_batchai_cluster_file_list_command_builder(this, cluster, resourceGroup, workspace);
    }
}

/** Commands to work with cluster nodes. */
export class az_batchai_cluster_node implements ICommandParent<any> {
    commandPath = "az batchai cluster node";
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_cluster_node_exec(cluster: string, resourceGroup: string, workspace: string): az_batchai_cluster_node_exec_command_builder {
        return new az_batchai_cluster_node_exec_command_builder(this, cluster, resourceGroup, workspace);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_cluster_node_list(cluster: string, resourceGroup: string, workspace: string): az_batchai_cluster_node_list_command_builder {
        return new az_batchai_cluster_node_list_command_builder(this, cluster, resourceGroup, workspace);
    }
}

/** Commands to manage clusters. */
export class az_batchai_cluster implements ICommandParent<any> {
    commandPath = "az batchai cluster";
     ...
     */
    az_batchai_cluster_auto_scale(max: string, min: string): az_batchai_cluster_auto_scale_command_builder {
        return new az_batchai_cluster_auto_scale_command_builder(this, max, min);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_cluster_create(name: string, resourceGroup: string, workspace: string): az_batchai_cluster_create_command_builder {
        return new az_batchai_cluster_create_command_builder(this, name, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_cluster_delete(): az_batchai_cluster_delete_command_builder {
        return new az_batchai_cluster_delete_command_builder(this);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_cluster_list(resourceGroup: string, workspace: string): az_batchai_cluster_list_command_builder {
        return new az_batchai_cluster_list_command_builder(this, resourceGroup, workspace);
    }
     ...
     */
    az_batchai_cluster_resize(target: string): az_batchai_cluster_resize_command_builder {
        return new az_batchai_cluster_resize_command_builder(this, target);
    }
     ...
     * ```
     */
    az_batchai_cluster_show(): az_batchai_cluster_show_command_builder {
        return new az_batchai_cluster_show_command_builder(this);
    }
}

/** Commands to manage experiments. */
export class az_batchai_experiment implements ICommandParent<any> {
    commandPath = "az batchai experiment";
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_experiment_create(name: string, resourceGroup: string, workspace: string): az_batchai_experiment_create_command_builder {
        return new az_batchai_experiment_create_command_builder(this, name, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_experiment_delete(): az_batchai_experiment_delete_command_builder {
        return new az_batchai_experiment_delete_command_builder(this);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_experiment_list(resourceGroup: string, workspace: string): az_batchai_experiment_list_command_builder {
        return new az_batchai_experiment_list_command_builder(this, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_experiment_show(): az_batchai_experiment_show_command_builder {
        return new az_batchai_experiment_show_command_builder(this);
    }
}

/** Commands to manage file servers. */
export class az_batchai_file_server implements ICommandParent<any> {
    commandPath = "az batchai file-server";
     ...
     */
    az_batchai_file_server_create(name: string, resourceGroup: string, workspace: string): az_batchai_file_server_create_command_builder {
        return new az_batchai_file_server_create_command_builder(this, name, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_file_server_delete(): az_batchai_file_server_delete_command_builder {
        return new az_batchai_file_server_delete_command_builder(this);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_file_server_list(resourceGroup: string, workspace: string): az_batchai_file_server_list_command_builder {
        return new az_batchai_file_server_list_command_builder(this, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_file_server_show(): az_batchai_file_server_show_command_builder {
        return new az_batchai_file_server_show_command_builder(this);
    }
}

/** Commands to list and stream files in job's output directories. */
export class az_batchai_job_file implements ICommandParent<any> {
    commandPath = "az batchai job file";
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_job_file_list(experiment: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_file_list_command_builder {
        return new az_batchai_job_file_list_command_builder(this, experiment, job, resourceGroup, workspace);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_job_file_stream(experiment: string, fileName: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_file_stream_command_builder {
        return new az_batchai_job_file_stream_command_builder(this, experiment, fileName, job, resourceGroup, workspace);
    }
}

/** Commands to work with nodes which executed a job. */
export class az_batchai_job_node implements ICommandParent<any> {
    commandPath = "az batchai job node";
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_job_node_exec(experiment: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_node_exec_command_builder {
        return new az_batchai_job_node_exec_command_builder(this, experiment, job, resourceGroup, workspace);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_job_node_list(experiment: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_node_list_command_builder {
        return new az_batchai_job_node_list_command_builder(this, experiment, job, resourceGroup, workspace);
    }
}

/** Commands to manage jobs. */
export class az_batchai_job implements ICommandParent<any> {
    commandPath = "az batchai job";
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_job_create(cluster: string, configFile: string, experiment: string, name: string, resourceGroup: string, workspace: string): az_batchai_job_create_command_builder {
        return new az_batchai_job_create_command_builder(this, cluster, configFile, experiment, name, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_job_delete(): az_batchai_job_delete_command_builder {
        return new az_batchai_job_delete_command_builder(this);
    }
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_job_list(experiment: string, resourceGroup: string, workspace: string): az_batchai_job_list_command_builder {
        return new az_batchai_job_list_command_builder(this, experiment, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_job_show(): az_batchai_job_show_command_builder {
        return new az_batchai_job_show_command_builder(this);
    }
     ...
     * ```
     */
    az_batchai_job_terminate(): az_batchai_job_terminate_command_builder {
        return new az_batchai_job_terminate_command_builder(this);
    }
     ...
     * ```
     */
    az_batchai_job_wait(): az_batchai_job_wait_command_builder {
        return new az_batchai_job_wait_command_builder(this);
    }
}

/** Commands to manage workspaces. */
export class az_batchai_workspace implements ICommandParent<any> {
    commandPath = "az batchai workspace";
     ...
     * @param {string} workspace Name of workspace.
     */
    az_batchai_workspace_create(resourceGroup: string, workspace: string): az_batchai_workspace_create_command_builder {
        return new az_batchai_workspace_create_command_builder(this, resourceGroup, workspace);
    }
     ...
     * ```
     */
    az_batchai_workspace_delete(): az_batchai_workspace_delete_command_builder {
        return new az_batchai_workspace_delete_command_builder(this);
    }
     ...
     * ```
     */
    az_batchai_workspace_list(): az_batchai_workspace_list_command_builder {
        return new az_batchai_workspace_list_command_builder(this);
    }
     ...
     * ```
     */
    az_batchai_workspace_show(): az_batchai_workspace_show_command_builder {
        return new az_batchai_workspace_show_command_builder(this);
    }
}

/** Manage Batch AI resources. */
export class az_batchai implements ICommandParent<any> {
    commandPath = "az batchai";
     ...
     */
    az_batchai_list_usages(location: string): az_batchai_list_usages_command_builder {
        return new az_batchai_list_usages_command_builder(this, location);
    }
}
...
class az_batchai_cluster_file_list_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, cluster: string, resourceGroup: string, workspace: string) {
        super(commandParent);
...
class az_batchai_cluster_auto_scale_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, max: string, min: string) {
        super(commandParent);
        this.max(max)
        this.min(min)
    }
...
class az_batchai_cluster_list_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, resourceGroup: string, workspace: string) {
        super(commandParent);
        this.resourceGroup(resourceGroup)
        this.workspace(workspace)
    }
...
class az_batchai_cluster_resize_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, target: string) {
        super(commandParent);
        this.target(target)
    }
...
class az_batchai_job_file_list_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, experiment: string, job: string, resourceGroup: string, workspace: string) {
        super(commandParent);
...
class az_batchai_job_file_stream_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, experiment: string, fileName: string, job: string, resourceGroup: string, workspace: string) {
        super(commandParent);
        this.experiment(experiment)
...
class az_batchai_job_create_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, cluster: string, configFile: string, experiment: string, name: string, resourceGroup: string, workspace: string) {
        super(commandParent);
        this.cluster(cluster)
...
class az_batchai_job_list_command_builder extends CommandBuilder {
    constructor(commandParent: ICommandParent<any>, experiment: string, resourceGroup: string, workspace: string) {
        super(commandParent);
        this.experiment(experiment)
        this.resourceGroup(resourceGroup)
        this.workspace(workspace)
