...
export class az_batchai_cluster_file {
     ...
     */
    static az_batchai_cluster_file_list(cluster: string, resourceGroup: string, workspace: string): az_batchai_cluster_file_list_command_builder {
...
export class az_batchai_cluster_node {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_cluster_node_exec(cluster: string, resourceGroup: string, workspace: string): az_batchai_cluster_node_exec_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_cluster_node_list(cluster: string, resourceGroup: string, workspace: string): az_batchai_cluster_node_list_command_builder {
...
export class az_batchai_cluster {
     ...
     */
    static az_batchai_cluster_auto_scale(max: string, min: string): az_batchai_cluster_auto_scale_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_cluster_create(name: string, resourceGroup: string, workspace: string): az_batchai_cluster_create_command_builder {
     ...
     * ```
     */
    static az_batchai_cluster_delete(): az_batchai_cluster_delete_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_cluster_list(resourceGroup: string, workspace: string): az_batchai_cluster_list_command_builder {
     ...
     */
    static az_batchai_cluster_resize(target: string): az_batchai_cluster_resize_command_builder {
     ...
     * ```
     */
    static az_batchai_cluster_show(): az_batchai_cluster_show_command_builder {
...
export class az_batchai_experiment {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_experiment_create(name: string, resourceGroup: string, workspace: string): az_batchai_experiment_create_command_builder {
     ...
     * ```
     */
    static az_batchai_experiment_delete(): az_batchai_experiment_delete_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_experiment_list(resourceGroup: string, workspace: string): az_batchai_experiment_list_command_builder {
     ...
     * ```
     */
    static az_batchai_experiment_show(): az_batchai_experiment_show_command_builder {
...
export class az_batchai_file_server {
     ...
     */
    static az_batchai_file_server_create(name: string, resourceGroup: string, workspace: string): az_batchai_file_server_create_command_builder {
     ...
     * ```
     */
    static az_batchai_file_server_delete(): az_batchai_file_server_delete_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_file_server_list(resourceGroup: string, workspace: string): az_batchai_file_server_list_command_builder {
     ...
     * ```
     */
    static az_batchai_file_server_show(): az_batchai_file_server_show_command_builder {
...
export class az_batchai_job_file {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_job_file_list(experiment: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_file_list_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_job_file_stream(experiment: string, fileName: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_file_stream_command_builder {
...
export class az_batchai_job_node {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_job_node_exec(experiment: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_node_exec_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_job_node_list(experiment: string, job: string, resourceGroup: string, workspace: string): az_batchai_job_node_list_command_builder {
...
export class az_batchai_job {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_job_create(cluster: string, configFile: string, experiment: string, name: string, resourceGroup: string, workspace: string): az_batchai_job_create_command_builder {
     ...
     * ```
     */
    static az_batchai_job_delete(): az_batchai_job_delete_command_builder {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_job_list(experiment: string, resourceGroup: string, workspace: string): az_batchai_job_list_command_builder {
     ...
     * ```
     */
    static az_batchai_job_show(): az_batchai_job_show_command_builder {
     ...
     * ```
     */
    static az_batchai_job_terminate(): az_batchai_job_terminate_command_builder {
     ...
     * ```
     */
    static az_batchai_job_wait(): az_batchai_job_wait_command_builder {
...
export class az_batchai_workspace {
     ...
     * @param {string} workspace Name of workspace.
     */
    static az_batchai_workspace_create(resourceGroup: string, workspace: string): az_batchai_workspace_create_command_builder {
     ...
     * ```
     */
    static az_batchai_workspace_delete(): az_batchai_workspace_delete_command_builder {
     ...
     * ```
     */
    static az_batchai_workspace_list(): az_batchai_workspace_list_command_builder {
     ...
     * ```
     */
    static az_batchai_workspace_show(): az_batchai_workspace_show_command_builder {
...
export class az_batchai {
     ...
     */
    static az_batchai_list_usages(location: string): az_batchai_list_usages_command_builder {
