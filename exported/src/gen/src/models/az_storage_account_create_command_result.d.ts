export declare type az_storage_account_create_command_result = az_storage_account_create_command_result_item[];
interface az_storage_account_create_command_result_item {
    accessTier: string;
